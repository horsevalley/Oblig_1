...
public class Leilighet extends Eiendom {
    ...
    public Leilighet(String adresse, String eiersNavn, double takst,
                     int antKvm, int gnr, int bnr, double fellesGjeld,
                     double husleie, int etg) {
    ...
    public String toString(){
        return String.format("Adresse: %s Eiers navn: %s Takst: %s" +
                " Antall kvm: %s Gnr: %s Bnr: %s Fellesgjeld: %s " +
                "Husleie: %s Etasje: %s", getAdresse(), getEiersNavn(),
                getTakst(), getAntKvm(), getGnr(), getBnr(), fellesGjeld,
                husleie, etg);
